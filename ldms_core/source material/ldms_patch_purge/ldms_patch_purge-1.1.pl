...
Win32::EventLog::Message::RegisterSource( 'Application', 'ldms_patch_purge' );
my $event = Win32::EventLog->new( 'ldms_patch_purge') || die "Can't open Event log!\n";
use Win32::EventLog::Carp qw(cluck carp croak click confess),
{
	Source => 'ldms_patch_purge'
};
