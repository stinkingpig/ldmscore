...
"select count(lastscantime) from UNMANAGEDNODES where lastscantime < ";
        ...
        if ($DEBUG) {
            ...
            $sql = "delete from UNMANAGEDNODES where wapdiscovered='0' and lastscantime < ";
            if ( $db_type eq "SQL" ) {
                $sql .= "getdate()-";
            }
            elsif ( $db_type eq "ORA" ) {
...
<H1>ldms_core LANDesk Statistics Report last updated at $rrdtime.<br />
<hr>
<!-- End Head -->
<table>
<tr>
...
<body>
<img src="ldms_core_icon.png">
<H1>$description last updated at <strong>$rrdtime</strong>.<br />
<hr>
<!-- End Head -->
<!-- Begin `Daily' Graph -->
			<h2>`Daily' Graph</h2>
